          ...
          <ul className="flex flex-col divide-y divide-rule border-y border-rule">
            {shown.map((paper, index) => {
              ...
              return (
                ...
                >
                  {/* Decoration only: out of flow, aria-hidden, and deaf to
                      the pointer. The row's marked state, its press feel and
                      its links are all exactly as they were. */}
                  <ScanSweep index={index} />
