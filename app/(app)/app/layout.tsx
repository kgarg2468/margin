 ...
 *
 * ⌘K is mounted here, inside `LabProvider` and around everything else, because
 * it is global to the authed app in both directions: the shortcut has to work
 * on any page, and the palette has to know which lab it is searching.
 */
